...
\newglossaryentry{Vikings}{
	name=the children of the spirits,
...
\newglossaryentry{Aztecs}{
	name=the servants of the serpent,
		...
		\subsubsection{Temple of the sun}
			...
			\paragraph{Level 1: Sanctum of the sun}
				...
				its curse is "Exhausting heat"\footnote{
					...
					This will slow them and their mounts down significaltly.
				}.
...
\section{\Gls{Egyptians}}
	...
	\subsection{Religion}
		...
		\subsubsection{Your duty is not yet done}
			Instead of teleporting back to a necropolis the affected soldires
...
% Stone to obsidian temple, sacrificing pepper
% Serpent feed with humans until eaten by sun/ is also base defence / it produces fertilizer for every sacrificed human
% 2 kinds of Mana serpent mana and sun mana. The later one gets replenished when the serpent is eaten
% Crying god: Sacrificing humans makes it cry. So it rains and the cord-fields are irrigated, which is the first step to produce more corn. The second is to wait or to put fertilizer on top
% Cooking god; Combines blood and corn starch into a new pale naked, Aztec
% Blood can be drained from Aztecs turning them pale. After eating two portions of food they regain their blood and are no longer pale.
% Their gimmick is that people are a resource for them
% The try to use clubs to take prisoners and sacrifice them instead of their own
% If the snake is not feed it eats random Aztecs of the street
% The snake can also be used to teleport people. To this end it forms a two way connection between the temple entrance and one point on the map allowing the Aztecs raid.
% One magic trick should permit the Aztecs to teleport enemies directly above the temple, so they are eaten by the serpent.
