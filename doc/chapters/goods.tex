...
\section{\Glsentrytext{Food}}\label{ch:Goods:Food}
...
\section{\Glsentrytext{Merchandise}}\label{ch:Goods:Merchandise}
...
Considering that the \hyperref[ch:Tribes]{tibes} produce a larger variety of
...
% Todo add Viking Gold jewlery

\subsection{\Gls*{Clothing}}

\subsection{\Gls*{Furniture}}

\section{\Glsentrytext{Equipment}}\label{ch:Goods:Equipment}
...
\section{\Glsentrytext{Tool}}\label{ch:Goods:Tools}
%Todo add picks
