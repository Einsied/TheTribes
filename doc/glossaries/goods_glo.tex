...
\newglossaryentry{Herb}{
	name=herb,
	type=good,
	description={can be harvested from \gls{Plant:Herb}}
}

\newglossaryentry{Mushroom}{
	name=mushroom,
	type=good,
	description={can be collected from \gls{Plant:Mushroom}}
}

\newglossaryentry{Chestnut}{
	name=chestnut,
	type=good,
	description={can be collected from \gls{ChestnutTree}}
}
...
\newglossaryentry{Coin}{
	name=coin,
	type=good,
	description={is a trade good. Coins are only produced for trade and have the smallest possible exchange value}
}
...
\newglossaryentry{Apple}{
	name=apple,
	type=good,
	description={growing on \gls{AppleTree}, these can be directly consumed as \gls{Food}}
}
