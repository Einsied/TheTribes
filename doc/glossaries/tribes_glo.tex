...
% Todo link the tribes as done for the goods in the text
\newglossaryentry{Vikings}{
	name=children of the spirits,
	type=tribe,
	description={are simple nature loving craftsmen,
			with a strong connection to the land and the nature that surrounds them.
			They are described in \autoref{ch:Tribes:Vikings}}
}
\newglossaryentry{Nomads}{
	name=mounted men,
	type=tribe,
	description={are fierce warriors and raiders, that raise large herds and conquer their foes
...
\newglossaryentry{Japanese}{
	name=empire,
	type=tribe,
	description={is a force of order.
